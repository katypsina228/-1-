...
namespace СП_Андреева_1_задание.warehouseDataSetTableAdapters {
    ...
    public partial class ЗаказчикTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::СП_Андреева_1_задание.Properties.Settings.Default.warehouseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = @"SELECT        ""id_Заказчик"", ФИО, ""Название_товара"", ""Номер_товара"", ""Паспортные_данные"", Возраст, Город, Страна, Регион, Адрес, ""Номер_телефона"", ""Дата_когда_был_сделан_заказ"", ""Дата_отправки"", 
                         ""Оформлена_накладная""
FROM            Заказчик";
        ...
        public virtual int Zakazik(warehouseDataSet.ЗаказчикDataTable dataTable) {
